...
export default function Contact(){
    ...
    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 text-black text-1xl font-small">
      ...
      <div className="bg-white-800 rounded-3xl md:col-span-2 p-6">
        <h2 className="text-2xl text-black-300 font-semibold">Product or Service Inquiry</h2>
        ...
        <form>
          ...
          <button type="button"
            className="mt-8 flex items-center justify-center text-sm w-full rounded-md px-4 py-2.5 text-gray-800 bg-yellow-400 hover:bg-yellow-500">
